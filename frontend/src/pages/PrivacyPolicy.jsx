      ...
      <div className="max-w-3xl mx-auto px-6">
        <div className="bg-white rounded-2xl shadow-sm p-8 sm:p-12 space-y-6">
          <header>
            ...
            <p className="text-secondary text-sm">Cập nhật lần cuối: 11/05/2026</p>
          </header>
          ...
          <Section title="1. Thông tin chúng tôi thu thập">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Thông tin thanh toán (qua VNPay, không lưu trữ thông tin thẻ)</li>
          ...
          <Section title="2. Mục đích sử dụng">
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Liên hệ khi cần thiết về chuyến đi (thay đổi lịch, hủy chuyến...)</li>
          ...
          <Section title="3. Chia sẻ thông tin">
            <p>
              BusGo cam kết <strong>không bán</strong> thông tin cá nhân cho bên thứ ba.
          ...
          <Section title="4. Bảo mật dữ liệu">
            <p>
              Chúng tôi sử dụng các biện pháp kỹ thuật như mã hóa SSL, băm mật khẩu (bcrypt),
              JWT token, và truy cập database qua kết nối an toàn để bảo vệ thông tin của bạn.
            </p>
          </Section>
          ...
          <Section title="6. Liên hệ">
            <p>
              ...
              <a href="mailto:support@busgo.vn" className="text-primary font-semibold hover:opacity-70">
                support@busgo.vn
              </a>
            </p>
          </Section>
